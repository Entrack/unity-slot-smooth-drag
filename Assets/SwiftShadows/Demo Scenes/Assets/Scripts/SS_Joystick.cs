...
public class SS_Joystick : MonoBehaviour {
    ...
    private static SS_Joystick[] SS_Joysticks; // A static collection of all SS_Joysticks
    private static bool enumeratedSS_Joysticks = false;
