...
public class SS_ThirdPersonController : MonoBehaviour {
    ...
    private void UpdateSmoothedMovementDirection() {
        ...
        float v = UseExternalInput ? ExternalInput.y : Input.GetAxisRaw("Vertical");
        float h = UseExternalInput ? ExternalInput.x : Input.GetAxisRaw("Horizontal");
